 ...
 */
package com.quocard.bookmanagement.jooq.tables.records;
...
public class BooksRecord extends UpdatableRecordImpl<BooksRecord> {
     ...
     */
    public BooksRecord(Long id, String title, Integer price, String publicationStatus) {
        super(Books.BOOKS);
     ...
     * Create a detached, initialised BooksRecord
     */
    public BooksRecord(com.quocard.bookmanagement.jooq.tables.pojos.Books value) {
        super(Books.BOOKS);
