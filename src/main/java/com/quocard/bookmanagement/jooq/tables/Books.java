 ...
 */
package com.quocard.bookmanagement.jooq.tables;


import com.quocard.bookmanagement.jooq.Keys;
import com.quocard.bookmanagement.jooq.Public;
import com.quocard.bookmanagement.jooq.tables.Authors.AuthorsPath;
import com.quocard.bookmanagement.jooq.tables.BookAuthors.BookAuthorsPath;
...
public class Books extends TableImpl<BooksRecord> {
     ...
     */
    public final TableField<BooksRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<BooksRecord, String> PUBLICATION_STATUS = createField(DSL.name("publication_status"), SQLDataType.VARCHAR(20).nullable(false), this, "");
    ...
    public Books where(Condition condition) {
        return new Books(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Books whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Books whereNotExists(TableLike<?> select) {
