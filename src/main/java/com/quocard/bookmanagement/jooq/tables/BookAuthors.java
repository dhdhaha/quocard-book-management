...
import com.quocard.bookmanagement.jooq.Indexes;
...
import com.quocard.bookmanagement.jooq.tables.Books.BooksPath;
...
public class BookAuthors extends TableImpl<BookAuthorsRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_BOOK_AUTHORS_AUTHOR_ID);
    }
    ...
    public BookAuthors where(Condition condition) {
        return new BookAuthors(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public BookAuthors whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public BookAuthors whereNotExists(TableLike<?> select) {
