...
public class Authors extends TableImpl<AuthorsRecord> {
     ...
     */
    public final TableField<AuthorsRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public Authors where(Condition condition) {
        return new Authors(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Authors whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Authors whereNotExists(TableLike<?> select) {
